...
export function AboutTimeline() {
  return (
    <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
      ...
      <div className="relative ml-4" role="list" aria-label="Анги амжилтууд">
        {/* Vertical line */}
        <div
          className="absolute top-0 bottom-0 left-0 w-0.5 rounded-full bg-primary/30"
          aria-hidden="true"
        />

        <div className="flex flex-col gap-8">
          {TIMELINE.map((item, index) => (
            <div key={index} className="relative pl-8" role="listitem">
              {/* Dot */}
              <div
